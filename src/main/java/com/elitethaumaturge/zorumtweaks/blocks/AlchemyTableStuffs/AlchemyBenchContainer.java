package com.elitethaumaturge.zorumtweaks.blocks.AlchemyTableStuffs;
...
public class AlchemyBenchContainer extends RecipeBookContainer<CraftingInventory> {
    private final CraftingInventory craftMatrix = new CraftingInventory(this, 3, 3);
    private final CraftResultInventory craftResult = new CraftResultInventory();
    private final IWorldPosCallable worldPosCallable;
    private final PlayerEntity player;

    public AlchemyBenchContainer(int id, PlayerInventory playerInventoryIn) {
        this(id, playerInventoryIn, IWorldPosCallable.DUMMY);
    }

    public AlchemyBenchContainer(int id, PlayerInventory playerInventoryIn, IWorldPosCallable p_i50090_3_) {
