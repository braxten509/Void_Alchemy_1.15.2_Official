...
public class StrangeSword extends SwordItem {

    public StrangeSword() {
        super(StrangeTier.STRANGE, 3, -2.4f, new Properties().group(ZorumTweaks.TAB));
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent("On critical hit: Jumpboost & Speed, 2 Health, Creates Void Energy").applyTextStyle(TextFormatting.GREEN));
