...
public class SpeculoInanis extends Item {
    public SpeculoInanis() {
        super((new Properties().group(ZorumTweaks.TAB)).maxStackSize(1));
    }

    @Override
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent("See through the empty eyes...").applyTextStyle(TextFormatting.GRAY));
    }
